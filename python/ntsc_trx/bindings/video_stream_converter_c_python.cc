...
/* BINDTOOL_HEADER_FILE_HASH(46250b192d5507719ad2a3db080ae338)                     */
/***********************************************************************************/
...
void bind_video_stream_converter_c(py::module& m)
{
    ...
    using video_stream_converter_c = ::gr::ntsc_trx::video_stream_converter_c;


    py::class_<video_stream_converter_c,
               gr::sync_decimator,
               std::shared_ptr<video_stream_converter_c>>(
        m, "video_stream_converter_c", D(video_stream_converter_c))
